...
(function() {
  var R, acre_m2, draw_acre, draw_box, fg, square_box, straight_line, to_deg, to_rad;
  ...
  draw_acre = function(map, layer, side_of_acre) {
    layer.clearLayers();
    return draw_box(layer, square_box(map.getCenter(), side_of_acre));
  };
